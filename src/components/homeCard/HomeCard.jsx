...
const HomeCard = () => {
  ...
  return (
    <div>
          <Banner />
          <div>
              {isLoading && <img className=" flex mx-auto items-center -my-60 absolute" src={loader} alt="loading" /> }
              {error && <h2 className='text-white text-center'>Upss.. something went wrong, please try again later...</h2>}
