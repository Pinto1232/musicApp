                    ...
                    <div key={items.id}>
                              <div className="flex items-strech justify-center flex-col md:flex-row 
                                ...
                                <h1 className="text-3xl lg:text-4xl text-white  
                                    font-semibold text-gray-800">Great Content</h1>
                                ...
                                <div>
                                    <div className="md:w-1/2 -z-50 gap-3 md:mt-0 flex w-fit mx-auto justify-center md:justify-end">
                                        {dataTopArtist?.data.slice(0, 2).map((itemsVideo) => (
                                            <div key={itemsVideo.id}>
                                                ...
                                                <span className="text-white grid justify-center">{itemsVideo.artist.name}</span>
                                            </div>
                                        ))}
                                        <div>
                                        </div>
                                  ...
                                  <div className="md:w-4/12 lg:w-5/12 xl:w-4/12 2xl:w-3/12 bg-gray-50 py-6 px-6 md:py-0 
                                    md:px-4 lg:px-6 flex flex-col justify-center relative">
                                      <div className="flex flex-col justify-center">
                                          {dataTopArtist?.data.slice(0, 1).map((shortTitle) => (
                                              <h1 key={shortTitle.id} className="text-3xl lg:text-4xl font-semibold 
